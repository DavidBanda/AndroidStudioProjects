...
public class MainActivityClima extends AppCompatActivity implements ListView.OnItemClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.activity_main_clima);
                lstClima = findViewById(R.id.lstView);
                lstClima.setAdapter(new weather_adapter(
                this,
                R.layout.activity_weather_adapter,
                cCiudades));
